...
class PlugTS_P(nn.Module):
    ...
    def fit(self, x_user, x_item, y, num_epoch=1, lamb=0, lr=0.01, batch_size=64):
        ...
        for epoch in range(num_epoch):
            ...
            for idx in range(total_batch):
                ...
                pred, _ = self.forward(sub_x_user,sub_x_item)
    ...
    def predict(self, x_user, x_item):
        with torch.no_grad():
            ...
            sigma = torch.sqrt(torch.sum(self.lamdba * self.nu * grad * grad, dim=1))
